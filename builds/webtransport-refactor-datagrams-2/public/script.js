        ...
        case 'datagram':
            ...
            while (printed_once == false) {
                if (sentCount == 1000) {
                    ...
                    // transport.close();
                    console.log("transport closed: " + sentCount);
                }
                let size = 1004;
                ...
                dv.setUint32(16, ts = (Date.now()/1000));
...
async function render(view){
    recvFramesCount++;
    // perceived_latency = perceived_latency + ((Date.now()/1000) - frame_first_sent);
    // if (recvCount >= 1000 && printed_once == false) {
    //     perceived_latency = perceived_latency/recvFramesCount;
    //     console.log(perceived_latency);
    //     printed_once = true;
