...
def perfTest(net, new_latency):
    ...
    cli1.cmd('cd ../../../../../../../media/sf_l4-project-quic/builds/webtransport-refactor-datagrams')
    ...
    cli2.cmd('cd ../../../../../../../media/sf_l4-project-quic/builds/webtransport-refactor-datagrams-2')
